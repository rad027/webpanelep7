...
@section('body')
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">WEB PANEL DATABASE CONFIGURATION</p>
            @include('partials.form-status')
            <div class="callout callout-warning">
                <h4>WEB PANEL DATABASE CONFIGURATION</h4>
                <p>
                    <ul>
            ...
            <form action="{{ URL('install/2') }}" method="POST">
                @csrf
                ...
                <a href="{{ URL('install') }}" class="btn btn-sm btn-danger">BACK</a>
