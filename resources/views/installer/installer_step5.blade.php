...
@section('body')
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">Ran Log DATABASE CONFIGURATION</p>
            @include('partials.form-status')
            <div class="callout callout-warning">
                <h4>WEB PANEL <b>RAN LOG</b> CONFIGURATION</h4>
                <p>
                    <ul>
            ...
            <form action="{{ URL('install/5') }}" method="POST">
                @csrf
                ...
                <a href="{{ URL('install/4') }}" class="btn btn-sm btn-danger">BACK</a>
