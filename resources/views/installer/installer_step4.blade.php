...
@section('body')
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">Ran User DATABASE CONFIGURATION</p>
            @include('partials.form-status')
            <div class="callout callout-warning">
                <h4>WEB PANEL <b>RAN User</b> CONFIGURATION</h4>
                <p>
                    <ul>
            ...
            <form action="{{ URL('install/4') }}" method="POST">
                @csrf
                ...
                <a href="{{ URL('install/3') }}" class="btn btn-sm btn-danger">BACK</a>
