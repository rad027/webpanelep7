...
@section('body')
    <div class="login-box">
        ...
        <div class="login-box-body">
            <p class="login-box-msg">Ran Game DATABASE CONFIGURATION</p>
            @include('partials.form-status')
            <div class="callout callout-warning">
                <h4>WEB PANEL <b>RAN GAME</b> CONFIGURATION</h4>
                <p>
                    <ul>
            ...
            <form action="{{ URL('install/3') }}" method="POST">
                @csrf
                ...
                <a href="{{ URL('install/2') }}" class="btn btn-sm btn-danger">BACK</a>
