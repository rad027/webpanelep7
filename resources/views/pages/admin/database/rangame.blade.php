...
@section('title', 'Ran Game Database')

@section('content_header')
    <h1>Ran Game Database</h1>
@stop
...
<div class="box">
	...
	<div class="box-body">
		<form action="{{ URL('db/rangame') }}" method="POST">
			@csrf
                <div class="form-group {{ $errors->has('DB_HOST') ? 'has-error' : '' }}">
                    <label>DB HOST :</label>
                    {!! Form::text('DB_HOST', env('DB_HOST_3'), array('id' => 'DB_HOST', 'class' => 'form-control', 'placeholder' => 'example : 127.0.0.1')) !!}
                ...
                <div class="form-group {{ $errors->has('DB_PORT') ? 'has-error' : '' }}">
                    <label>DB PORT :</label>
                    {!! Form::text('DB_PORT', env('DB_PORT_3'), array('id' => 'DB_PORT', 'class' => 'form-control', 'placeholder' => 'example : 1433')) !!}
                ...
                <div class="form-group {{ $errors->has('DB_DATABASE') ? 'has-error' : '' }}">
                    <label>DB Name :</label>
                    {!! Form::text('DB_DATABASE', env('DB_DATABASE_3'), array('id' => 'DB_DATABASE', 'class' => 'form-control', 'placeholder' => 'example : webpanel_db')) !!}
                ...
                <div class="form-group {{ $errors->has('DB_USERNAME') ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('DB_USERNAME', env('DB_USERNAME_3'), array('id' => 'DB_USERNAME', 'class' => 'form-control', 'placeholder' => 'example : root')) !!}
                ...
                <div class="form-group {{ $errors->has('DB_PASSWORD') ? 'has-error' : '' }}">
                    ...
                    {!! Form::text('DB_PASSWORD', env('DB_PASSWORD_3'), array('id' => 'DB_PASSWORD', 'class' => 'form-control', 'placeholder' => 'example : 1234')) !!}
